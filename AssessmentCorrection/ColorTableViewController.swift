//
//  ColorTableTableViewController.swift
...
class ColorTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       selectedColor = self.crayons[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.backgroundColor = UIColor(red: CGFloat(crayonsAtIndexPath.red), green: CGFloat(crayonsAtIndexPath.green), blue: CGFloat(crayonsAtIndexPath.blue), alpha: 1.0)
